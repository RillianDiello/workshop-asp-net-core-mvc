...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            if (_context.Department.Any() || _context.SalesRecord.Any() || _context.Seeler.Any())
            {
                return;
            }
            ...
            Seeler s1 = new Seeler(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seeler s2 = new Seeler(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seeler s3 = new Seeler(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, d1);
            Seeler s4 = new Seeler(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 11, 30), 3000.0, d4);
            Seeler s5 = new Seeler(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 4000.0, d3);
            Seeler s6 = new Seeler(6, "Alex Pink", "bob@gmail.com", new DateTime(1997, 3, 4), 3000.0, d2);
            ...
            _context.Seeler.AddRange(s1, s2, s3, s4, s5);
